export default function ProfileView({profileData, profileAttr}) {
                    ...
                    <article>
                        ...
                        <div>
                            ...
                            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                                ...
                                <div className="hidden sm:block 2xl:hidden mt-6 min-w-0 flex-1">
                                    <h1 className="text-2xl font-bold text-gray-900 truncate">{`${profileData.firstName} ${profileData.lastName}`}</h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-6 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                            <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                                {profileAttr && profileAttr.map((attr) => (
                                    <div className="sm:col-span-1" key={attr.label}>
                                        <dt className="text-sm font-medium text-gray-500">{attr.label}</dt>
